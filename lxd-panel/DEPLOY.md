...
```bash
curl -fsSL https://raw.githubusercontent.com/你的用户名/仓库名/main/quick_install.sh | bash
```

或者使用wget：

```bash
wget -qO- https://raw.githubusercontent.com/你的用户名/仓库名/main/quick_install.sh | bash
```
...
```bash
# 1. 克隆仓库
git clone https://github.com/你的用户名/lxd-panel.git
cd lxd-panel
