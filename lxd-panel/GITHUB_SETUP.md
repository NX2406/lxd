...
假设您的GitHub仓库是: `https://github.com/john/lxd-panel`

### 1. 修改quick_install.sh

```bash
GITHUB_REPO="https://github.com/john/lxd-panel.git"
```
...
# 一键安装
curl -fsSL https://raw.githubusercontent.com/john/lxd-panel/main/quick_install.sh | bash
